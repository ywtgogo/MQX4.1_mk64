...
#define IO_IOCTL_DELETE_SECTORS	     _IO(IO_TYPE_MQX,0x1B)
#define IO_IOCTL_DELETE_DONE         _IO(IO_TYPE_MQX,0x1C)
#define IO_IOCTL_FLUSH_DRIVE	     _IO(IO_TYPE_MQX,0x1D)
#define IO_IOCTL_GET_FREEPAGES	     _IO(IO_TYPE_MQX,0x1E)
...
#define IO_DEV_TYPE_PHYS_SPIFLASH	     (0x0021)
