   ...
   )
{
   ...
   EMMC_DEVICE_DATA *   pDevDataParam_ptr;
   _mqx_int             result = MQX_OK;
   ...
   switch (cmd)
   {
      ...
      case IO_IOCTL_DEVICE_IDENTIFY:
         ...
         break;
      case IO_IOCTL_SDCARD_GET_DEVICE_INFO:
          pDevDataParam_ptr = (EMMC_DEVICE_DATA*)param_ptr;
          memcpy( pDevDataParam_ptr, &sdcard_ptr->DEVICEINFO, sizeof( EMMC_DEVICE_DATA ) );
          break;
      default:
