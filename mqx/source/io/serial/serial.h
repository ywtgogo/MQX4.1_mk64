...
//custom
#define IO_IOCTL_SERIAL_GET_LEN          _IO(IO_TYPE_SERIAL,0x30)
#define IO_IOCTL_SERIAL_CLEAR_BUF        _IO(IO_TYPE_SERIAL,0x31)
/*--------------------------------------------------------------------------*/
/*
**                      FUNCTION PROTOTYPES
*/
...
extern void 	_io_serial_default_shutdown(void);
